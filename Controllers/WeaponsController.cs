...
namespace WitcherKendoEFDemo.Controllers
{
    public class WeaponsController : Controller
    {
        ...
        public WeaponsController(WitcherKendoEFDemoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("WeaponID,Name,AttackPower")] Weapon weapon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("WeaponID,Name,AttackPower")] Weapon weapon)
        {
